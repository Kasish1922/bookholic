...
<?php
	...
	<div class="wrapper">
		...
		<form action="login.php" method="post">
			...
			<div class="account">
				Don't have an account? <a href="registration.php">Sign Up Now</a><br> Go to Home Page <a href="art.php">Home</a>
				<br><a href="adminLogin.php">Admin Login</a><br> Go to Home Page <a href="art.php">Home</a>
			</div>
		</form>
	</div>
